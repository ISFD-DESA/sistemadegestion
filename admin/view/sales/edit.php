          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class='pull-right'>
					<a href="sale-print.php?id=<?php echo $_SESSION['sale_id'];?>" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Imprimir</a>
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <label>Cliente</label>
                                        <select class="form-control select2" name="customer_id" onchange="return update_sale(this.value);">
