		...
		if (empty($_POST['product_id'])){
			...
			// escaping, additionally removing everything that could be (html/javascript-) code
				...
				// update data
					...
					note='".$note."',status='".$status."', manufacturer_id='".$manufacturer_id."', buying_price='".$buying_price."', selling_price='".$selling_price."', profit='".$profit."' WHERE product_id='$product_id' ";
