    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p style="color: #FFF">Saavedra 526</p>
                <p style="color: #FFF">Barrio San Agustin</p>
                <p style="font-size:20px" aria-hidden="true">  000 – 0800 / 999 – 235689</p>
                <p class="fa fa-mobile" style="font-size:20px"  aria-hidden="true">  3704845568 / 3704235689</p> <a href="#" target="_blank" style="color: #5bc0de">envianos_un_mensaje</a></br>
                E-mail: <a href="#" target="_blank" style="color: #5bc0de"> &nbsp; lacumbre@dominio.com</a>
            </div>
        </div>
    </div>
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">LACUMBRE &copy; 2024</h5>
</footer>
